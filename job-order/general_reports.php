...
<tbody>
  ...
  <tr>
    ...
    <td></td>
    <td><p><?php $sql =  "SELECT sum(amount) as total FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Person with Disability'  "; $result = $con->query($sql); while ($row = $result->fetch_assoc()) { echo $row['total']; $total6 = $row['total']; } ?></p></td>
 </tr>
  <tr>
    ...
    <td></td>
    <td><p><?php $sql =  "SELECT sum(amount) as total FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Senior Citizen'  "; $result = $con->query($sql); while ($row = $result->fetch_assoc()) { echo $row['total']; $total7 = $row['total']; } ?></p></td>
  </tr>
 <tr>
	<?php $totalc = $countc; ?>
