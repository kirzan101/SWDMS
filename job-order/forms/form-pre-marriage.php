				...
				<p style="font-weight: bold; color: blue;" >Woman (Babae)</p>
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
					...
					<div class='input-group date' type="date" id='myDatepicker22'>
                            <input type='text' class="form-control" name="bdayf" id="bday" value="<?php if (empty($bdayf)) { echo "".date("m/d/y").""; } else { echo date('m/d/y', strtotime($bdayf)); } ?>" onblur="submitBday2()" onkeyup="submitBda2y()"   />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
