...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM interview_log l INNER JOIN client c, interview i, client_dwyna_details d WHERE l.client_id = c.client_id AND l.interview_id = i.interview_id AND l.service_id = 7 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND d.type_of_abuse = 'Physical Abuse' AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM interview_log l INNER JOIN client c, interview i, client_dwyna_details d WHERE l.client_id = c.client_id AND l.interview_id = i.interview_id AND l.service_id = 7 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND d.type_of_abuse = 'Physical Abuse' AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM interview_log l INNER JOIN client c, interview i, client_dwyna_details d WHERE l.client_id = c.client_id AND l.interview_id = i.interview_id AND l.service_id = 7 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND d.type_of_abuse = 'Sexual Abuse' AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM interview_log l INNER JOIN client c, interview i, client_dwyna_details d WHERE l.client_id = c.client_id AND l.interview_id = i.interview_id AND l.service_id = 7 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND d.type_of_abuse = 'Sexual Abuse' AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM interview_log l INNER JOIN client c, interview i, client_dwyna_details d WHERE l.client_id = c.client_id AND l.interview_id = i.interview_id AND l.service_id = 7 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND d.type_of_abuse = 'Verbal Abuse' AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Person with Disability'  AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Person with Disability'  AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Senior Citizen'  AND i.interview_date BETWEEN '$from' AND '$to'";
...
if($con->query($sql)){
			...
			$sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Senior Citizen'  AND i.interview_date BETWEEN '$from' AND '$to'";
