...
$sql = "SELECT * FROM client c INNER JOIN client_dwyna_details s, interview i WHERE s.client_id = $client_id && c.client_id = $client_id && i.client_id = $client_id && s.client_dwyna_detail_id = $count_no";
