...
$sql = "SELECT * FROM client c INNER JOIN client_child_details s, interview i WHERE s.client_id = $client_id && c.client_id = $client_id && i.client_id = $client_id && s.client_child_detail_id = $count_no";
