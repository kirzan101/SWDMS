...
$sql = "SELECT * FROM client c INNER JOIN assistance s, interview i, client_general_details g WHERE s.client_id = $client_id && c.client_id = $client_id && i.client_id = $client_id && g.interview_id = s.interview_id && s.interview_id = $count_no && c.client_id = g.client_id";
