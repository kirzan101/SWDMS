...
{
	$con = mysqli_connect("localhost", "root", "Canaman2018", "swdo");
...
<tbody>
  ...
  <tr>
    ...
    <td><p><?php $sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id  AND a.interview_id = d.interview_id  AND d.category = 'Person with Disability' AND i.interview_date BETWEEN '$from' AND '$to'"; if ($result=mysqli_query($con,$sql)) { $rowcount=mysqli_num_rows($result); printf($rowcount); $countm23 = $rowcount; mysqli_free_result($result); } ?></p></td>
    <td><p><?php $sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND a.interview_id = d.interview_id  AND d.category = 'Person with Disability' AND i.interview_date BETWEEN '$from' AND '$to'"; if ($result=mysqli_query($con,$sql)) { $rowcount=mysqli_num_rows($result); printf($rowcount); $countf23 = $rowcount; mysqli_free_result($result); } ?></p></td>
    <td></td>
    <td><p><?php $sql =  "SELECT sum(amount) as total FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Person with Disability'  AND a.interview_id = d.interview_id   AND i.interview_date BETWEEN '$from' AND '$to'"; $result = $con->query($sql); while ($row = $result->fetch_assoc()) { echo $row['total']; $total6 = $row['total']; } ?></p></td>
 </tr>
  <tr>
    <td>&nbsp; Senior Citizen</td>
    <td><p><?php $sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Male' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND a.interview_id = d.interview_id  AND d.category = 'Senior Citizen' AND i.interview_date BETWEEN '$from' AND '$to'"; if ($result=mysqli_query($con,$sql)) { $rowcount=mysqli_num_rows($result); printf($rowcount); $countm24 = $rowcount; mysqli_free_result($result); } ?></p></td>
    <td><p><?php $sql =  "SELECT * FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.sex = 'Female' AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND a.interview_id = d.interview_id  AND d.category = 'Senior Citizen' AND i.interview_date BETWEEN '$from' AND '$to'"; if ($result=mysqli_query($con,$sql)) { $rowcount=mysqli_num_rows($result); printf($rowcount); $countf24 = $rowcount; mysqli_free_result($result); } ?></p></td>
    <td></td>
    <td><p><?php $sql =  "SELECT sum(amount) as total FROM assistance a INNER JOIN client c, interview i, interview_log l, client_death_aid_details d WHERE a.client_id = c.client_id AND a.interview_id = i.interview_id AND a.service_id = 10 AND l.service_id = 10 AND c.status = 'ACTIVE' AND i.interview_id = l.interview_id AND d.category = 'Senior Citizen'  AND a.interview_id = d.interview_id  AND i.interview_date BETWEEN '$from' AND '$to'"; $result = $con->query($sql); while ($row = $result->fetch_assoc()) { echo $row['total']; $total7 = $row['total']; } ?></p></td>
  </tr>
 <tr>
	<?php $totalc = $countc; ?>
