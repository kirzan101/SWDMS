		...
		<!-- Query for client -->
		<?php include 'query/query-dascpd.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_dascpd.php'; } ?>
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				 ...
				 <!-- Start row-->
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
					...
					<input type="text" class="form-control" maxlength="20" name="amount" id="edit1" placeholder="0.00" onchange="make_decimal1(this.name, this.value); return 0;"  onfocus="if (this.value == '0.00') {this.value = '';}" onblur="if (this.value == '') {this.value = '0.00'; }" value="<?php echo $amount;?>"    />
