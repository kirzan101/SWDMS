				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  <select name="color" class="form-control" id="color" >
						  <option style="color:#ffff00;" value="Yellow">Yellow</option>
						</select>
					</div>
				  </div>
				  <div class="form-group">
			  ...
			  <div class="modal-body">
				  ...
				  <div class="form-group">
					...
					<div class="input-group date" type="date" id="datetimepicker666">
                            <input type='text' class="form-control" name="start" id="start1" required />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                    </div>
				  ...
				  <div class="form-group">
					...
					<div class="input-group date" type="date" id="datetimepicker6666">
                            <input type='text' class="form-control" name="end" id="end1" required />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                    </div>
