		...
		<?php include 'error/error-handling-rloa.php'; ?>
		
		<!-- Query for client -->
		<?php include 'query/query-scsr.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_rloa.php'; } ?>
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				 ...
				 <label for="message">Assestment * :</label>
                          <textarea id="message"  =" " class="form-control" name="assessment" maxlength="1000" ><?php echo $assestment;?></textarea>
				 ...
				 <!-- Start row-->
				  ...
				  <p style="font-weight: bold;" >III. Refferal Information </p>

				  <div class="col-md-5 col-sm-12 col-xs-12 form-group">
                    <label for="">Reffered Agency * :</label>
						<input type="text" class="form-control"  placeholder="Reffered Agency" maxlength="50" onkeypress="return validateKeyStrokes(event)" name="referral_details" value="<?php echo $referral_details;?>"   />
						<span class="error"> <?php echo $referral_detailsErr;?></span>
				  </div>
				...
				<div class="row">
				 ...
				 <label for="message">Refferal lettter * :</label>
                          <textarea id="message"  =" " class="form-control" name="referral_letter_details" maxlength="1000"  ><?php echo $referral_letter_details;?></textarea>
						  <span class="error"> <?php echo $referral_letter_detailsErr;?></span>
