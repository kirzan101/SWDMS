		...
		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/insert_cicl.php'; } ?>
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >III. Social Worker's Assesment/Problem Presented</p>
				  ...
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    ...
                    <input type="text" name="type" placeholder="Type of Offense" class="form-control" maxlength="30" onkeypress="return validateKeyStrokes(event)" value="<?php echo $type;?>"  >
					<span class="error"> <?php echo $typeErr;?></span>
                  </div>

                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">committed * :</label>
					<input type="text" name="committed" placeholder="committed" class="form-control" maxlength="30" onkeypress="return validateKeyStrokes(event)" value="<?php echo $committed;?>"  >
					<span class="error"> <?php echo $committedErr;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">To whom * :</label>
					<input type="text" name="whom" placeholder="To Whom" class="form-control" maxlength="30" onkeypress="return validateKeyStrokes(event)" value="<?php echo $whom;?>"  >
					<span class="error"> <?php echo $committedErr;?></span>
                  </div>
				...
				<div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    ...
                    <input type="text" name="refer" placeholder="Referred By" class="form-control" maxlength="30" onkeypress="return validateKeyStrokes(event)" value="<?php echo $refer;?>"  >
