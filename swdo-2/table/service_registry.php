  ...
  <div id="modalHomeEvents" class="modal fade" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<div class="list-group">
		<h4>Others:</h4>
        <a type="button" class="list-group-item" href="../choose/choose-cicl.php?client_id=" id="link6">Children in Conflict with the Law</a>
		<a type="button" class="list-group-item" href="../choose/choose-livelihood.php?client_id=" id="link10">Livelihood Assistance</a>
		<a type="button" class="list-group-item" href="../choose/choose-scsr.php?client_id=" id="link15">Social Case Study</a>
		<a type="button" class="list-group-item" href="../choose/choose-pre-marriage.php?client_id=" id="link11">Pre-marriage Counselling</a>
		<a type="button" class="list-group-item" href="../choose/choose-rloa.php?client_id=" id="link14">Referral to other Agencies</a>
		<a type="button" class="list-group-item" href="../choose/choose-indigency.php?client_id=" id="link9">Certificate of Indigency</a>
		...
		<a type="button" class="list-group-item" href="../choose/choose-dwyna.php?client_id=" id="link8">Welfare of Socially Disadvantaged Women, Youth & Other Needy Adult</a>
		</div>
        </div>
		</div>
