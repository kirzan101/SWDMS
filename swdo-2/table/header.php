            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
				  ...
				  <li><a href="service_registry.php"><i class="fa fa-suitcase"></i> Service Registry </a>
                  </li>
				  <li><a href="index.php"><i class="fa fa-user"></i> Client Registry </a>
                  </li>
