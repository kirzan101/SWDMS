		...
		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/insert_solo-parent.php'; } ?>
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				  ...
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
					...
					<input type="text" class="form-control" maxlength="30" name="incomem" value="" id="edit1" placeholder="0.00" onchange="make_decimal1(this.name, this.value); return 0;"  onfocus="if (this.value == '0.00') {this.value = '';}" onblur="if (this.value == '') {this.value = '0.00'; }" value="<?php echo $incomem;?>"    />
				...
				<div class="row" >
				 ...
				 <p style="font-weight: bold;" >III. Classification/Circumtances of being a Solo Parent</p>
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >IV. Needs/Problems of Solo Parents</p>
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >V. Family Resources</p>
