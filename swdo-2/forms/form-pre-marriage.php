		...
		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/insert_pre-marriage.php'; } ?>
            ...
            <div class="x_panel">
			  ...
			  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="barangay">Barangay * :</label>
						<select class="select2_single form-control" name="barangaym" tabindex="-1"  >
							...
							<option value="San Roque" <?php if($barangaym == 'San Roque') { echo 'selected'; } else { echo ''; } ?> >San Roque</option>
				...
				<p style="font-weight: bold; color: blue;" >Woman (Babae)</p>
                  ...
                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
				    <label for="name">First Name * :</label>
                    <input type="text" name="firstnamef" placeholder="First Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $firstnamem;?>"  >
					<span class="error"> <?php echo $firstnamefErr;?></span>
                  </div>

                  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Middle Name * :</label>
					<input type="text" name="middlenamef" placeholder="Middle Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $middlenamem;?>"  >
					<span class="error"> <?php echo $middlenamefErr;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="name">Last Name * :</label>
					<input type="text" name="lastnamef" placeholder="Last Name" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $lastnamem;?>"  >
				  ...
				  <div class="col-md-1 col-sm-12 col-xs-12 form-group">
                    <label for="age">Age * :</label>
					<p style="font-weight: bold; font-size: 16px; text-align: center;" id="resultBday2" ></p>
                  </div>
				  
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="bday">Date of Birth * :</label>
					<div class='input-group date' type="date" id='myDatepicker22'>
                            <input type='text' class="form-control" name="bdayf" id="bday2" value="<?php if (empty($bdayf)) { echo "".date("m/d/y").""; } else { echo date('m/d/y', strtotime($bdayf)); } ?>" onblur="submitBday2()" onkeyup="submitBday2()"   />
                            <span class="input-group-addon">
                               <span class="glyphicon glyphicon-calendar"></span>
                            </span>
                        </div>
				  ...
				  <div class="col-md-6 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Birthplace * :</label>
					<input type="text" name="bplacef" placeholder="Birthplace" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $bplacem;?>"   >
				  ...
				  <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                    <label for="civil">Civil Status * :</label>
                      <p  >
                        Single:
                        <input type="radio" class="flat" name="civilf" value="Single" <?php if ( isset($civilm) && $civilf == 'Single') { echo 'checked'; }?> /> 
						Married:
                        <input type="radio" class="flat" name="civilf" value="Married"  <?php if ( isset($civilm) && $civilf == 'Married') { echo 'checked'; }?> /> 
						Other:
                        <input type="radio" class="flat" name="civilf" value="Other" <?php if ( isset($civilm) && $civilf == 'Other') { echo 'checked'; }?> />
                      </p>
				  ...
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="religion">Religion :</label>
					<input type="text" name="religionf" placeholder="Religion" class="form-control" onkeypress="return validateKeyStroke(event)" maxlength="30" value="<?php echo $religionm;?>"  >
                  </div>
				  
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="tel">Telephone :</label>
					<input type="text" name="telf" placeholder="999-99-99" class="form-control" data-inputmask="'mask': '999-99-99'" maxlength="30" value="<?php if (empty($telephonem)) { echo ""; } else { echo $telephonem; } ?>"  >
                  </div>
				  
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="contactno">Contact No. :</label>
					<input type="text" name="contactnof" placeholder="0999-999-9999" class="form-control" data-inputmask="'mask': '9999-999-9999'" maxlength="30" value="<?php if (empty($contactnom)) { echo ""; } else { echo $contactnom; } ?>"  >
                  </div>
				  ...
				  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label for="preadd">Present Address * :</label>
					<input type="text" name="preaddf" placeholder="Present Address" class="form-control" maxlength="50" value="<?php echo $preaddm;?>"  >
					<p><i>No./ Building / Street / City/Municipality / District/Province / Region</i></p>
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="barangay">Barangay * :</label>
						<select class="select2_single form-control" name="barangayf" tabindex="-1"  >
                            <option></option>
							<option value="Baras" <?php if($barangayf == 'Baras') { echo 'selected'; } else { echo ''; } ?> >Baras</option>
							<option value="Del Rosario" <?php if($barangayf == 'Del Rosario') { echo 'selected'; } else { echo ''; } ?>  >Del Rosario</option>
							<option value="Dinaga" <?php if($barangayf == 'Dinaga') { echo 'selected'; } else { echo ''; } ?> >Dinaga</option>
							<option value="Fundado" <?php if($barangayf == 'Fundado') { echo 'selected'; } else { echo ''; } ?>  >Fundado</option>
							<option value="Haring" <?php if($barangayf == 'Haring') { echo 'selected'; } else { echo ''; } ?> >Haring</option>
							<option value="Iquin" <?php if($barangayf == 'Iquin') { echo 'selected'; } else { echo ''; } ?> >Iquin</option>
							<option value="Linaga" <?php if($barangayf == 'Linaga') { echo 'selected'; } else { echo ''; } ?> >Linaga</option>
							<option value="Mangayawan" <?php if($barangayf == 'Mangayawan') { echo 'selected'; } else { echo ''; } ?> >Mangayawan</option>
							<option value="Palo" <?php if($barangayf == 'Palo') { echo 'selected'; } else { echo ''; } ?> >Palo</option>
							<option value="Pangpang" <?php if($barangayf == 'Pangpang') { echo 'selected'; } else { echo ''; } ?> >Pangpang</option>
							<option value="Poro" <?php if($barangayf == 'Poro') { echo 'selected'; } else { echo ''; } ?> >Poro</option>
							<option value="San Agustin" <?php if($barangayf == 'San Agustin') { echo 'selected'; } else { echo ''; } ?> >San Agustin</option>
							<option value="San Francisco" <?php if($barangayf == 'San Francisco') { echo 'selected'; } else { echo ''; } ?>  >San Francisco</option>
							<option value="San Jose East" <?php if($barangayf == 'San Jose East') { echo 'selected'; } else { echo ''; } ?> >San Jose East</option>
							<option value="San Jose West" <?php if($barangayf == 'San Jose West') { echo 'selected'; } else { echo ''; } ?> >San Jose West</option>
							<option value="San Juan" <?php if($barangayf == 'San Juan') { echo 'selected'; } else { echo ''; } ?> >San Juan</option>
							<option value="San Nicolas" <?php if($barangayf == 'San Nicolas') { echo 'selected'; } else { echo ''; } ?> >San Nicolas</option>
							<option value="San Roque" <?php if($barangayf == 'San Roque') { echo 'selected'; } else { echo ''; } ?> >San Roque</option>
							<option value="San Vicente" <?php if($barangayf == 'San Vicente') { echo 'selected'; } else { echo ''; } ?> >San Vicente</option>
							<option value="Santa Cruz" <?php if($barangayf == 'Santa Cruz') { echo 'selected'; } else { echo ''; } ?> >Santa Cruz</option>
							<option value="Santa Teresita" <?php if($barangayf == 'Santa Teresita') { echo 'selected'; } else { echo ''; } ?> >Santa Teresita</option>
							<option value="Sua" <?php if($barangayf == 'Sua') { echo 'selected'; } else { echo ''; } ?> >Sua</option>
							<option value="Talidtid" <?php if($barangayf == 'Talidtid') { echo 'selected'; } else { echo ''; } ?> >Talidtid</option>
							<option value="Tibgao" <?php if($barangayf == 'Tibgao') { echo 'selected'; } else { echo ''; } ?> >Tibgao</option>
						</select>
				  ...
				  <div class="col-md-5 col-sm-4 col-xs-12 form-group">
                    <label for="proadd">Provincial Address * :</label>
					<input type="text" name="proaddf" placeholder="Provincial Address" value="Camarines Sur" class="form-control" onkeypress="return validateKeyStroke(event)" maxlength="30" value="<?php echo $proaddm;?>"   >
					<span class="error"> <?php echo $proaddfErr;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="educ">Highest Educational Attainment * :</label>
						<input type="text" class="form-control" name="educf" placeholder="Highest Educational Attainment" onkeypress="return validateKeyStroke(event)"  maxlength="30" value="<?php echo $educm;?>"  >
				  ...
				  <div class="col-md-2 col-sm-12 col-xs-12 form-group">
                    <label for="proadd">Philhealth No. :</label>
						<input type="text" class="form-control" name="philnf" style="text-transform: lowercase;" placeholder="xxxx-xxxx-xxxx" data-inputmask="'mask' : '9999-9999-9999'" value="<?php echo $philnm;?>" >
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="proadd">Skills/Occupation * :</label>
						<input type="text" class="form-control" name="skillf"  maxlength="30" placeholder="Skills/Occupation"  onkeypress="return validateKeyStroke(event)" value="<?php echo $skillm;?>"   >
						<span class="error"> <?php echo $skillfErr;?></span>
				  </div>
				  
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="proadd">Monthly Income * :</label>
						<input type="text" class="form-control" name="mincomef"  maxlength="30" placeholder="0.00" id="edit1" onchange="make_decimal(this.name, this.value); return 0;" onfocus="if (this.value == '0.00') {this.value = '';}" onblur="if (this.value == '') {this.value = '0.00'; }" value="<?php echo $mincomem;?>"   />
						<span class="error"> <?php echo $mincomefErr;?></span>
				  </div>
				  
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="proadd">Estimated Family Income * :</label>
						<input type="text" class="form-control" name="incomef"  maxlength="30" placeholder="0.00" id="edit1" onchange="make_decimal1(this.name, this.value); return 0;"  onfocus="if (this.value == '0.00') {this.value = '';}" onblur="if (this.value == '') {this.value = '0.00'; }" value="<?php echo $incomem;?>"   />
				...
				<div class="row" >
				  ...
				  <div class="col-md-8 col-sm-12 col-xs-12 form-group">
                    <label for="family_head">Family Head * :</label>
						<input type="text" class="form-control" name="family_headf" placeholder="Family Head" onkeypress="return validateKeyStroke(event)" maxlength="50" value="<?php echo $family_headm;?>"  >
						<span class="error"> <?php echo $family_headfErr;?></span>
				  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="family_head">Position in the Family * :</label>
						<select class="select2_single form-control" name="positionf" tabindex="-1" >
							<option></option>
							<option value="Mother" <?php if ($positionf == 'Mother') { echo 'selected'; } ?> >Mother</option>
							<option value="Father" <?php if ($positionf == 'Father') { echo 'selected'; } ?> >Father</option>
							<option value="Spouse" <?php if ($positionf == 'Spouse') { echo 'selected'; } ?> >Spouse</option>
							<option value="Son" <?php if ($positionf == 'Son') { echo 'selected'; } ?> >Son</option>
							<option value="Daughter" <?php if ($positionf == 'Daughter') { echo 'selected'; } ?> >Daughter</option>
							<option value="Brother" <?php if ($positionf == 'Brother') { echo 'selected'; } ?> >Brother</option>
							<option value="Sister" <?php if ($positionf == 'Sister') { echo 'selected'; } ?> >Sister</option>
							<option value="Grandfather" <?php if ($positionf == 'Grandfather') { echo 'selected'; } ?> >Grandfather</option>
							<option value="Grandmother" <?php if ($positionf == 'Grandmother') { echo 'selected'; } ?> >Grandmother</option>
							<option value="Uncle" <?php if ($positionf == 'Uncle') { echo 'selected'; } ?> >Uncle</option>
							<option value="Auntie" <?php if ($positionf == 'Auntie') { echo 'selected'; } ?> >Auntie</option>
							<option value="Cousin"  <?php if ($positionf == 'Cousin') { echo 'selected'; } ?> >Cousin</option>
							<option value="Niece" <?php if ($positionf == 'Niece') { echo 'selected'; } ?> >Niece</option>
							<option value="Relative" <?php if ($positionf == 'Relative') { echo 'selected'; } ?> >Relative</option>
						</select>
				...
				<div class="row" >  
				  <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label for="preadd">Address After Marriage * :</label>
					<input type="text" name="afaddf" placeholder="Address After Marriage" class="form-control" maxlength="50" value="<?php echo $afaddm;?>"  >
					<p><i>No./ Building / Street / City/Municipality / District/Province / Region</i></p>
