		...
		<!-- Error Handling -->
		<?php include 'error/error-handling-2.php'; ?>
		...
		<!-- Servicce Error Handling-->
		<?php include 'error/error-handling-solo-parent.php'; ?>
		
		<!-- Query for client -->
		<?php include 'query/query-solo-parent.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_solo-parent.php'; } ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h4>SIssuance of Solo Parent ID</h4>
              </div>
            ...
            <div class="x_panel">
			  ...
			  <?php $client = '?client_id='.$client_id.'&&count='.$count; ?>
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				  ...
				  <div class="col-md-3 col-sm-12 col-xs-12 form-group">
                    <label for="proadd">Skills/Occupation * :</label>
						<input type="text" class="form-control" name="skill"  maxlength="30" placeholder="Skills/Occupation"  onkeypress="return validateKeyStroke(event)" value="<?php echo $skill;?>"  required>
						<span class="error"> <?php echo $skillErr;?></span>
				  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="incomem">Monthly Income * :</label>
					<input type="text" class="form-control" maxlength="30" name="incomem" value="" id="edit1" placeholder="0.00" onchange="make_decimal1(this.name, this.value); return 0;"  onfocus="if (this.value == '0.00') {this.value = '';}" onblur="if (this.value == '') {this.value = '0.00'; }" value="<?php echo $incomem;?>"  required />
				 ...
				 <p style="font-weight: bold;" >II. Classification/Circumtances of being a Solo Parent</p>
				 
				 <label for="message">Assestment * :</label>
                          <textarea id="message"   class="form-control" name="classification" maxlength="1000" ><?php echo $classification;?></textarea>
						  <input type="text" name="assestment" value="<?php echo $assestment;?>" hidden /><!-- NOTE: Not include in the form. For declaring variable purposes. Please ignore. -->
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >III. Needs/Problems of Solo Parents</p>
				 
				 <label for="message">Assestment * :</label>
                          <textarea id="message"   class="form-control" name="needs" maxlength="1000" ><?php echo $needs;?> </textarea>
						  <span class="error"> <?php echo $needsErr;?></span>
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >IV. Family Resources</p>
				 
				 <label for="message">Assestment * :</label>
                          <textarea id="message"   class="form-control" name="resources" maxlength="1000" ><?php echo $resources;?> </textarea>
						  <span class="error"> <?php echo $resourcesErr;?></span>
