		...
		<?php include 'error/error-handling-indigency.php'; ?>
		
		<!-- Query for client -->
		<?php include 'query/query-indigency.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_indigency.php'; } ?>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h4>Securing Certificate of Indigency</h4>
              </div>
            ...
            <div class="x_panel">
			  ...
			  <!-- Hidden values -->
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >III. Background Information</p>
