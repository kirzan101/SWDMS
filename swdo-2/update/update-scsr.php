		...
		<?php include 'error/error-handling-scsr.php'; ?>
		
		<!-- Query for client -->
		<?php include 'query/query-scsr.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_scsr.php'; } ?>
            ...
            <div class="x_panel">
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				 ...
				 <p style="font-weight: bold;" >III. Social Worker's Assesment/Problem Presented</p>
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >IV. Background Information</p>
				 
				 <label for="message">Background * :</label>
                          <textarea id="message"   class="form-control" name="background" maxlength="1000" ><?php echo $background;?></textarea>
						  <span class="error"> <?php echo $backgroundErr;?></span>
				...
				<div class="row">
				 ...
				 <p style="font-weight: bold;" >V. Recommendation</p>
				 
				 <label for="message">Recommendation * :</label>
                          <textarea id="message"   class="form-control" name="recommendation" maxlength="1000" ><?php echo $recommendation;?></textarea>
