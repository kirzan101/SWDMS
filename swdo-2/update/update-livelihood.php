		...
		<?php include 'error/error-handling-livelihood.php'; ?>
		
		<!-- Query for client -->
		<?php include 'query/query-livelihood.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_livelihood.php'; } ?>
            ...
            <div class="x_panel">
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >I. Identifying Information</p>
				 ...
				 <p style="font-weight: bold;" >II. Training Need Choice</p>
				 
				 <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Training needs 1 * :</label>
					<input type="text" name="choice1" placeholder="Training needs 1" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $choice1;?>"  >
					<span class="error"> <?php echo $choice1Err;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Training needs 2 * :</label>
					<input type="text" name="choice2" placeholder="Training needs 2" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $choice2;?>"  >
					<span class="error"> <?php echo $choice2Err;?></span>
                  </div>
				  
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Training needs 3 * :</label>
					<input type="text" name="choice3" placeholder="Training needs 3" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $choice3;?>" >
					<span class="error"> <?php echo $choice3Err;?></span>
                  </div>
				...
				<div class="row">
				 ...
				 <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                    <label for="bplace">Startup Kit * :</label>
					<input type="text" name="startup" placeholder="Startup Kit" class="form-control" maxlength="50" onkeypress="return validateKeyStrokess(event)" value="<?php echo $startup;?>" >
					<span class="error"> <?php echo $startupErr;?></span>
                  </div>
