		...
		<!-- Query for client -->
		<?php include 'query/query-dwyna.php'; ?>

		<!-- SQL Insert file -->
		<?php if ($countErr == 1) { echo ""; } else { include '../action/update_dwyna.php'; } ?>
            ...
            <div class="x_panel">
			  ...
			  <!-- Hidden values -->
				...
				<p style="font-weight: bold;" >II. Social Worker's Assesment/Problem Presented</p>
				  ...
				  <div class="col-md-4 col-sm-12 col-xs-12 form-group">
				    <label for="name">Type of Abuse * :</label>
                    <input type="text" name="type" placeholder="Type of Abuse" class="form-control" maxlength="30" onkeypress="return validateKeyStroke(event)" value="<?php echo $type;?>"  >
