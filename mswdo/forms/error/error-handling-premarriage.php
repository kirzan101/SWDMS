...
$proaddmErr = $educmErr = $skillmErr = $incomemErr = $mincomemErr = $family_headmErr = $positionmErr = $afaddmErr = "";

// Required variables
$firstnamem = $middlenamem = $lastnamem = $sexm = $bdaym = $bplacem = $civilm = $preaddm = $barangaym = "";
$proaddm = $educm = $skillm = $incomem = $mincomem = $family_headm = $positionm = $afaddm = "";
...
$proaddfErr = $educfErr = $skillfErr = $incomefErr = $mincomefErr = $family_headfErr = $positionfErr = $afaddfErr = "";

// Required variables
$firstnamef = $middlenamef = $lastnamef = $sexf = $bdayf = $bplacef = $civilf = $preaddf = $barangayf = "";
$proaddf = $educf = $skillf = $incomef = $mincomef = $family_headf = $positionf = $afaddf = "";
...
$contactnom = $_POST["contactnom"];
  ...
  if (empty($_POST["family_headm"])) {
    $family_headmErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $family_headm = premarriage_input($_POST["family_headm"]);
  }
  
  if (empty($_POST["positionm"])) {
    $positionmErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $positionm = premarriage_input($_POST["positionm"]);
  }
...
$contactnof = $_POST["contactnof"];
  ...
  if (empty($_POST["family_headf"])) {
    $family_headfErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $family_headf = premarriage_input($_POST["family_headf"]);
  }
  
  if (empty($_POST["positionf"])) {
    $positionfErr = "This field is REQUIRED";
	$countErr = 1;
  } else {
    $positionf = premarriage_input($_POST["positionf"]);
  }
